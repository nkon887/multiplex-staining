...
def processing(base_dir, target_dir, step):
    ...
    if step == "STITCHING":
        ...
        if step == "ALIGNMENT":
            ...
            precrop_input_dir = ht.correct_path(working_dir, "02_01_input_to_precrop")
            stacks_dir = ht.setting_directory(working_dir, "02_02_stacks")
            cropped_stacks_dir = ht.setting_directory(working_dir, "02_03_cropped_input")
            ...
            alignment_dir = ht.correct_path(working_dir, "02_alignment")
            bg_adjust_dir = ht.setting_directory(working_dir, "03_bg_processed")
