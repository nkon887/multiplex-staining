...
class App:
    def __init__(self, master, pipeline_params, dapiseg_steps, command_arguments, packages, envs, main_work_dir):
        ...
        for parameterset in parametersets:
            ...
            if package == self.packages[1] and env != "":
                command.append(f"conda activate {env} && {package} main.py --target {destination} --working_dir "
                               ...
                               f"--dapiseg_steps {dapiseg_steps_string_space_sep} && conda deactivate")
                ...
                command.append(
                    ...
                    f"'{pipeline_steps_string_komma_sep}'\"")
