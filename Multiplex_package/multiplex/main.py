...
def processing():
    ...
    if step == align_steps_list[0]:
        ...
        PreparationDapiSeg(bg_adjust_dir, dapi_seg_input_dir, pcf.dapi_str, pcf.tiff_ext, work_dir, forceSave).process()
    ...
    #    logger.info("Segmentation Completed")
        ...
        PostProcessingDapiSeg(ht.correct_path(dapi_seg_output_dir, "visual_output"),
                              ...
                              pcf.tiff_ext, forceSave).process()
        ...
        Cropping_Before_After_Alignment_Experimental_Extracting_Coords(pre_input_dir, input_dir, target_dir,
                                                                       ...
                                                                       cropped_suffix,
                                                                       forceSave).processing_after_alignment()
    elif step == cropping_exp_steps_list[1]:
        from multiplex.cropping_before_after_alignment_experimental_with_direct_automatic_cut import \
        ...
        SettingParams(bg_input_dir, txt_dir, infos_txt, input_dir, tiff_ext, dapi_str, metadata_csv_file,
                      work_dir, pcf.csv_ext, forceSave).processing()
